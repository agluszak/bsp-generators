...
object Main {
    ...
    fun main(args: Array<String>) {
        ...
        val test = "cargo test -q --manifest-path \$BUILD_WORKSPACE_DIRECTORY/$name/Cargo.toml"

        val generator = FilesGenerator(name, output, generatorScript, codegenFiles, listOf(clippy, fmt, test))
